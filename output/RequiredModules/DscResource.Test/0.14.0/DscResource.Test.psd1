@{
    ...
    FunctionsToExport = @('Clear-DscLcmConfiguration','Initialize-TestEnvironment','Invoke-DscResourceTest','New-DscSelfSignedCertificate','Restore-TestEnvironment')
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes               = '## [0.14.0] - 2020-08-08
